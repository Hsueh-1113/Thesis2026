...
svy: regress d_ghq_likert i.bame `controls'

count
local N_pool = r(N)

post_lc `reghold' "regression" 1 "Model 1: pooled" "main" "BAME" "_b[1.bame]"
...
svy, subpop(if bame==1): regress d_ghq_likert `controls'

count if bame==1
local N_bame = r(N)

post_lc `reghold' "regression" 2 "Model 2: BAME" "employment" "Employment reduction" "_b[emp_red]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "employment" "Job loss" "_b[emp_loss]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "employment" "Key worker" "_b[key_yes]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "employment" "Self-employed" "_b[selfemp_yes]"

post_lc `reghold' "regression" 2 "Model 2: BAME" "financial" "Financial difficulties" "_b[fin_base_yes]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "financial" "Financial better" "_b[fin_better]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "financial" "Financial worse" "_b[fin_worse]"

post_lc `reghold' "regression" 2 "Model 2: BAME" "housing" "Bedroom-per-person ratio" "_b[bedratio_base]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "housing" "Bedroom-per-person ratio squared" "_b[bedratio_sq]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "housing" "Number of rooms" "_b[hsrooms_base2]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "housing" "Number of rooms squared" "_b[rooms_sq]"

post_lc `reghold' "regression" 2 "Model 2: BAME" "health" "COVID symptoms" "_b[covid_symp]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "health" "Respiratory condition" "_b[cc_resp]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "health" "Cardiovascular condition" "_b[cc_cardio]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "health" "Endocrine condition" "_b[cc_endo]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "health" "Arthritis" "_b[cc_arth]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "health" "Other chronic condition" "_b[cc_other]"

post_lc `reghold' "regression" 2 "Model 2: BAME" "household" "Single occupancy" "_b[single_occ]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "household" "Dependent children" "_b[base_ndep]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "household" "Dependent children squared" "_b[kids_sq]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "household" "Single occupancy x children" "_b[single_kids]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "household" "Single occupancy x children squared" "_b[single_kids_sq]"

post_lc `reghold' "regression" 2 "Model 2: BAME" "demographics" "Female" "_b[female]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "demographics" "Age 16-29" "_b[age16_29]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "demographics" "Age 30-49" "_b[age30_49]"
post_lc `reghold' "regression" 2 "Model 2: BAME" "demographics" "Age 50-69" "_b[age50_69]"

post_lc `reghold' "regression" 2 "Model 2: BAME" "constant" "Constant" "_b[_cons]"
post_obs `reghold' "regression" 2 "Model 2: BAME" `N_bame'
...
svy, subpop(if bame==0): regress d_ghq_likert `controls'

count if bame==0
local N_nonbame = r(N)

post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "employment" "Employment reduction" "_b[emp_red]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "employment" "Job loss" "_b[emp_loss]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "employment" "Key worker" "_b[key_yes]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "employment" "Self-employed" "_b[selfemp_yes]"

post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "financial" "Financial difficulties" "_b[fin_base_yes]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "financial" "Financial better" "_b[fin_better]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "financial" "Financial worse" "_b[fin_worse]"

post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "housing" "Bedroom-per-person ratio" "_b[bedratio_base]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "housing" "Bedroom-per-person ratio squared" "_b[bedratio_sq]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "housing" "Number of rooms" "_b[hsrooms_base2]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "housing" "Number of rooms squared" "_b[rooms_sq]"

post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "health" "COVID symptoms" "_b[covid_symp]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "health" "Respiratory condition" "_b[cc_resp]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "health" "Cardiovascular condition" "_b[cc_cardio]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "health" "Endocrine condition" "_b[cc_endo]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "health" "Arthritis" "_b[cc_arth]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "health" "Other chronic condition" "_b[cc_other]"

post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "household" "Single occupancy" "_b[single_occ]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "household" "Dependent children" "_b[base_ndep]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "household" "Dependent children squared" "_b[kids_sq]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "household" "Single occupancy x children" "_b[single_kids]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "household" "Single occupancy x children squared" "_b[single_kids_sq]"

post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "demographics" "Female" "_b[female]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "demographics" "Age 16-29" "_b[age16_29]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "demographics" "Age 30-49" "_b[age30_49]"
post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "demographics" "Age 50-69" "_b[age50_69]"

post_lc `reghold' "regression" 3 "Model 2: Non-BAME" "constant" "Constant" "_b[_cons]"
post_obs `reghold' "regression" 3 "Model 2: Non-BAME" `N_nonbame'
...
save "${out}/Appendix/BAME/appendix.dta", replace
export delimited using "${out}/Appendix/BAME/appendix.csv", replace
...
*--------------------------------------------------*
* Column 2: WM price / Non-BAME price
* group 1 = bame==0 = WM
*--------------------------------------------------*
oaxaca d_ghq_likert ///
    emp_red emp_loss key_yes selfemp_yes ///
...
save "${out}/Appendix/BAME/appendix_oaxaca.dta", replace
export delimited using "${out}/Appendix/BAME/appendix_oaxaca.csv", replace
